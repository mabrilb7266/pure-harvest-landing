...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "NaturWay: La senda del alimento puro. Tienda de comida ecológica premium." },
      { name: "author", content: "NaturWay" },
      { property: "og:title", content: "NaturWay — Tienda de Comida Ecológica" },
      { property: "og:description", content: "Natural siempre es mejor." },
